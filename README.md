...
| | |
|---|---|
| Guest image_id | `71442f7b757c93edf1a14b0535a68b427d80818a156a9eb4ff2c936cfbc2e65b` (sound in-circuit anchored binding + distributed trust) |
...
`71442f7b…` that every shipped proof verifies against. Changing the root changes the guest,
...
proofs/               four real proofs (dev_mode:false, 71442f7b)
...
> `71442f7b…`, and produces `zkvm/target/release/host`, which every other command
...
`71442f7b…`, proving the source in this tree reproduces the shipped artifacts.
